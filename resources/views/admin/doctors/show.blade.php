...
@stop
@section('feature-title', 'Thông tin bác sĩ')
@section('back-page')
				...
				<div class="box-body box-profile">
					...
					<ul class="list-group list-group-unbordered">
						<li class="list-group-item">
							<b>Ngày tạo tài khoản</b> <span class="pull-right">{{$doctor->created_at}}</span>
						</li>
						<li class="list-group-item">
							<b>Ngày cập nhật mới nhất</b> <span class="pull-right">{{$doctor->updated_at}}</span>
						</li>
					</ul>
					...
					<div class="modal fade" id="alertModal" role="dialog">
					 	<div class="modal-dialog modal-sm">
					 		<form id="deleteForm" role="form" method="POST" action="{{ route('doctor.destroy', $doctor->id) }}">
								{{ csrf_field() }}
				...
				<form role="form" method="POST" action="{{ route('doctor.update', $doctor->id) }}">
					...
					<div class="box-body">
						...
						<div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
							...
							name="dob"
							class="form-control"
							value="{{ date_format(date_create($doctor->dob),'m/d/Y') }}" 
							id="datepicker"
